...
lr  = [0.00005, 0.0005, 0.001]
betasright = [0.999, 0.998, 0.997]
...
for NUM_LAYERS1 in num_layers1:
    for NUM_LAYERS2 in num_layers2:
        for NUM_LAYERS3 in num_layers3:
            for HIDDEN_SIZE in hidden_size1:
                for DROPOUT1 in dropOut1:
                    for DROPOUT2 in dropOut2:
                        for DROPOUT3 in dropOut3:
                                counter = counter + 1
                                ...
                                print(optimizer)
                                print("hidden_size: ", HIDDEN_SIZE, "num_layers1: ", NUM_LAYERS1,"num_layers2: ", NUM_LAYERS2,"num_layers3: ", NUM_LAYERS3, "Dropout1: ", DROPOUT1, "Dropout2: ", DROPOUT2 ,"Dropout3: ", DROPOUT3)
                                print("round: ", counter, " out of 2187")
